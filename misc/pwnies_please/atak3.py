...
def get_image_to_attack(url='http://pwnies-please.chal.uiuc.tf'):
    '''
    uses session global
    '''
...
def post_adversarial_image(url='http://pwnies-please.chal.uiuc.tf', img_file='/tmp/atak.png'):
    '''
...
def sanity_check():
    ...
    l = len("you snuck SOMETHING into the club but it wasn't a pwny (changed too much, ground truth thinks image is a: ")
